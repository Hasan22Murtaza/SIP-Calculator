...
// import "rangeslider.js/dist/rangeslider.css"; // Import the CSS for the rangeslider
// import "rangeslider.js"; // Ensure you have installed rangeslider.js
// import $ from "jquery";
...
//   const [stepUpValue, setStepUpValue] = useState(14); // Default value
...
//     setStepUpValue(event.target.value);
//   };
...
//     if (isStepUpChecked) {
//       monthlyInvestment += (stepUpValue / 100) * investment;
//     }
...
//     if (!isNaN(value)) {
//       setInvestment(value);
//       setMaturityAmount(parseFloat(calculateSIP(value, rate, years)));
//     }
//   };
...
//     if (!isNaN(value)) {
//       setRate(value);
//       setMaturityAmount(parseFloat(calculateSIP(investment, value, years)));
//     }
//   };
...
//     if (!isNaN(value)) {
//       setYears(value);
//       setMaturityAmount(parseFloat(calculateSIP(investment, rate, value)));
//     }
//   };
...
//       accumulatedAmount +=
//         monthlyInvestment * Math.pow(1 + rate / 100 / 12, years * 12 - i);

//       if (stepUpChecked) {
//         monthlyInvestment += (monthlyInvestment * stepUpValue) / 100;
//       }
//       if (inflationChecked) {
//         monthlyInvestment -= (monthlyInvestment * inflationValue) / 100;
//       }
//     }

//     setMaturityAmount(accumulatedAmount.toFixed(2));
//   };

//   useEffect(() => {
//     // Calculate maturity amount on component mount and when inputs change
//     setMaturityAmount(parseFloat(calculateSIP(investment, rate, years)));

//     // Initialize jQuery and rangeslider only in client-side
//     const initSliders = () => {
...
//                     >
//                       <li className="font-medium py-3 px-4 sm:px-6 lg:p-5 w-1/2 rounded-t text-center dark:text-white text-my-black -mb-px border-b-2 border-transparent text-[#159D2C] active">
//                         <a
//                           id="default-tab"
//                           href="#first"
...
//                         </a>
//                       </li>
//                       <li className="font-medium py-3 px-4 sm:px-6 lg:p-5 w-1/2 rounded-t text-my-black dark:text-white text-center border-b-2 border-transparent">
//                         <a
//                           href="#second"
...
//                               max={50000}
//                               step={100}
//                               value={investment} // Use 'value' instead of 'defaultValue'
//                               onChange={handleInvestmentChange} // Update onChange
//                             />
//                           </div>
//                         </div>
//                         <div className="flex flex-col gap-3 mb-4">
...
//                               step={10}
//                               value={rate} // Use 'value' instead of 'defaultValue'
//                               onChange={handleRateChange} // Update onChange
//                             />
//                           </div>
//                         </div>
//                         <div className="flex flex-col gap-3 mb-4">
...
//                               type="text"
//                               className="rounded-xl bg-[rgba(21,157,44,0.05)] border border-[rgba(21,157,44,0.20)] py-2.5 px-4 text-base font-medium text-my-black text-right transition-all duration-500 hover:border-[#159D2C] focus:border-[#159D2C] focus:text-[#159D2C] outline-none dark:text-white md:max-w-max max-w-[115px]"
//                               value={years} // Use 'value' instead of 'defaultValue'
...
//                               step={5}
//                               value={years} // Use 'value' instead of 'defaultValue'
//                               onChange={handleYearsChange} // Update onChange
//                             />
//                           </div>
//                         </div>
//                         <div className="mt-6">
...
//                                   type="checkbox"
//                                   defaultValue=""
//                                   className="w-[26px] h-[26px] appearance-none border cursor-pointer border-[#159D2C] rounded-lg mr-2 hover:border-[#159D2C] checked:bg-no-repeat checked:bg-center checked:bg-[#159D2C] checkbox-1"
//                                 />
//                                 <label
...
//                             <input
//                               type="text"
//                               className="rounded-xl bg-[rgba(21,157,44,0.05)] border border-[rgba(21,157,44,0.20)] py-2 px-4 text-base font-medium text-my-black text-right transition-all duration-500 hover:border-[#159D2C] focus:border-[#159D2C] focus:text-[#159D2C] outline-none dark:text-white md:max-w-max max-w-[115px] checkbox-1-input hidden"
//                               defaultValue={14}
//                             />
//                           </div> */}
//                           <div className="flex items-center justify-between gap-5 mb-3">
...
//                               <div className="flex items-center gap-1">
//                                 <input
//                                   id="checkbox-default3"
//                                   type="checkbox"
//                                   defaultValue=""
//                                   className="w-[26px] h-[26px] appearance-none border cursor-pointer border-[#159D2C] rounded-lg mr-2 hover:border-[#159D2C] checked:bg-no-repeat checked:bg-center checked:bg-[#159D2C] checkbox-1"
//                                 />
//                                 <label
//                                   htmlFor="checkbox-default3"
//                                   className="lg:text-lg text-base cursor-pointer text-my-black dark:text-white"
//                                 >
//                                   Step- Up
//                                 </label>
...
//                               <div className="flex items-center gap-1">
//                                 <input
//                                   id="checkbox-default4"
//                                   type="checkbox"
//                                   defaultValue=""
//                                   className="w-[26px] h-[26px] appearance-none border cursor-pointer border-[#159D2C] rounded-lg mr-2 hover:border-[#159D2C] checked:bg-no-repeat checked:bg-center checked:bg-[#159D2C] checkbox-1"
//                                 />
//                                 <label
//                                   htmlFor="checkbox-default4"
//                                   className="lg:text-lg text-base cursor-pointer text-my-black dark:text-white"
//                                 >
//                                   Adjust for Inflation
//                                 </label>
...
//                       <h5 className="text-base text-my-black font-bold dark:text-white">
//                         ₹
//                         {isStepUpChecked ? (investment * stepUpValue) / 100 : 0}
//                         .00
//                       </h5>
//                     </div>
//                     <div className="flex items-center justify-between">
...
//                       </span>
//                       <h5 className="text-base text-my-black font-bold dark:text-white">
//                         ₹{(maturityAmount - investment * years * 12).toFixed(2)}
//                       </h5>
//                     </div>
//                   </div>
//                   <div className="flex items-center justify-between">
...
//                   <div id="chart" className="pie-chart flex justify-center" />
...
//         {/*ad section start*/}
//         <div className="relative lg:py-[50px] py-8">
//           <div className="max-w-6xl mx-auto px-3">
//             <img src="assets/images/ad-image.png" alt="image" />
//           </div>
//         </div>
//         {/*ad section end*/}
...
//                   calculator&nbsp;is a tool that helps you determine the returns
//                   you can avail when parking your funds in such investment
//                   tools. Systematic Investment Plan or&nbsp;SIP&nbsp;is a
//                   process of investing a fixed sum of money in mutual funds at
...
//                     Whether you’re aiming for long-term wealth creation or
...
//                     </span>
//                     Choose the period you want to stay invested. It could range
...
//                     </span>{" "}
//                     The expected return rate (CAGR) is typically based on the
//                     historical performance of the mutual funds you're
//                     considering. You can enter your own estimate or use the
...
//   const [maturityAmount, setMaturityAmount] = useState(0);
//   const [isStepUpChecked, setIsStepUpChecked] = useState(false);
//   const [stepUpValue, setStepUpValue] = useState(14);
...
//   const handleStepUpValueChange = (event) => {
//     setStepUpValue(parseInt(event.target.value));
//   };
...
//     setInflationValue(parseInt(event.target.value));
//   };
...
//       try {
//         // Only import rangeslider.js on the client side
...
//   // Initialize ApexCharts separately with proper client-side check
//   useEffect(() => {
//     if (typeof window !== "undefined" && chartRef.current) {
//       // Calculate the invested amount and returns for the chart
//       const investedAmount = investment * years * 12;
//       const totalReturns = maturityAmount - investedAmount;

//       const options = {
//         series: [investedAmount, totalReturns],
...
//       }
//     };
//   }, [investment, rate, years, maturityAmount]);
...
//                       <div id="second" className="hidden">
//                         {/* Lump Sum Tab Content - simplified for now */}
//                         <div className="p-4 text-center text-my-black dark:text-white">
//                           Lump Sum calculator functionality will be implemented
//                           soon.
//                         </div>
//                       </div>
//                     </div>
...
//                       </span>
//                       <h5 className="text-base text-my-black font-bold dark:text-white">
//                         ₹{(investment * years * 12).toLocaleString()}
//                       </h5>
//                     </div>
//                     <div className="flex items-center justify-between">
//                       <span className="text-base font-medium text-my-black dark:text-white">
...
//                         ₹
//                         {isStepUpChecked
//                           ? ((investment * stepUpValue) / 100).toLocaleString()
//                           : 0}
//                       </h5>
//                     </div>
//                     <div className="flex items-center justify-between">
